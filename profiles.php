<?php
    ...
    if(isset($_POST['buatpp'])){
        ...
        if( $buat > 0 ) {
            echo "<script>
            alert('Profil Anda berhasil dibuat!')
            </script>";
        }
        else
        {
            echo "<script>
            alert('Profil Anda gagal dibuat!')
            </script>";
        }
    }
    ...
    if(isset($_POST['ubahpp'])){
        ...
        {
            echo "<script>
            alert('Profil Anda gagal diubah!')
            </script>";
        }
    }
...
<?php while( $row = mysqli_fetch_assoc($result) ) : ?>
    ...
    <div class ="row">
        ...
        <a href="editprofile.php?id=<?= $row["id"]; ?>" class="member-btn">Edit Profile</a> 
        </div>
    </div> 
